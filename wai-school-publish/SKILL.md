...
Use this skill when the student wants to publish, upload, deploy, share, or get a public link for an HTML/CSS/JS project.

The goal is simple: bundle the current project, upload it to WAI School, and return the real link. Do not invent links.
